...
<head>
    ...
    <link rel="stylesheet" href="css/rosaleda-onepage.css">
</head>
<body>
    ...
    <div class="section animated-row slide-02" data-section="slide02" style="margin: 100px 0 100px 0;">
                        ...
                        <div class="row">
                                ...
                                <div class="about-contentbox">
                                    <div>
                                        <div class="section-heading">
                                            ...
                                            <h2>Our lorem ipsum <em>is to dolor</em> ametis postekam dohaer sistikaf amet</h2>
                            ...
                            <div class="col-md-7">
                                <div id='tabs'>
                                    ...
                                    <article id='tabs-3'>
                                        <p>Farm-to-table af direct trade tumblr, bespoke paleo venmo PBRBsta neutra vegan craft beer echo park. Echo park hell of ugh, synthicasti coloring book cardigan truffaut hexagon dreamcatcher microdosingil este.<br><br>Farm-to-table af direct trade tumblr, bespoke paleo venmo PBRBsta lorem ipsum dolor amet ningun postedam postekaris istifaris ostekam et valar dohaeris istikam vegan craft beer echo park. Echo park hell of ugh, synthicasti coloring book cardigan.</p>
                                        <a href="#">More about us</a>
                                    </article>
                                    </section>
                                </div>
    ...
    <div class="get-to-know-what-we-do">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="home-section-heading">
                        <span>Get to know what we do</span>
                        <h2>Get familiar with <em>our services</em></h2>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <div class="fun-facts home-facts">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div class="fact-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="home-section-heading">
                        <span>faq's</span>
                        <h2>Most <em>frequently asked questions</em> by some of the clients</h2>
                        <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type if specimen book. Lorem Ipsum has been the industry's standard dummy text ever a since the 1500s, when an unknown printer.</p>
                    </div>
                </div>
                <div class="col-md-6 align-self-center">
                    <ul class="accordion">
